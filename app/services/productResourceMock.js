...
(function (angular) {
    ...
    app.run(function ($httpBackend) {
        ...
        var singleUrl = new RegExp(productUrl + "/[0-9][0-9]*", '');
        $httpBackend.whenGET(singleUrl)
            .respond(function (method, url, data) {
                ...
                if (id > 0) {
                    product = _.find(products, function (p) {
        ...
        $httpBackend.whenPOST(productUrl)
            .respond(function (method, url, data) {
        ...
        $httpBackend.whenGET(new RegExp("products/")).passThrough();
